 ...
 *
 * <ul>
 *   <li>Millions of virtual threads can run concurrently</li>
 *   <li>Ideal for I/O-bound tasks (HTTP, database, file I/O)</li>
 *   <li>NOT for CPU-bound tasks (use platform threads/ForkJoinPool)</li>
 *   <li>Managed by JVM, not OS - minimal memory footprint</li>
 * </ul>
 *
 * <p>Java 25: Virtual threads are production-ready and the recommended approach
...
public class VirtualThreadExample {
  ...
  static void creatingVirtualThreads() throws Exception {
    ...
    System.out.println("\n  Main thread is virtual? " + current.isVirtual());
