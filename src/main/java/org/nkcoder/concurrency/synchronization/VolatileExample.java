 ...
 *
 * <p><strong>Java 25 Note:</strong> {@code volatile} remains relevant for visibility guarantees
 * (flags, status variables, DCL pattern). For atomic operations, prefer {@code Atomic*} classes.
 *
 * <p>Key concepts:
 * <ul>
 *   <li>Guarantees visibility: all threads see latest value</li>
 *   <li>Prevents instruction reordering around volatile access</li>
 *   <li>Does NOT provide atomicity for compound operations</li>
 *   <li>Lighter weight than synchronized</li>
 * </ul>
 *
 * <p>Interview tip: Know what volatile guarantees (visibility) and what
 * it doesn't (atomicity). Classic question: is volatile enough for a counter?
 */
public class VolatileExample {
  ...
  static void volatileNotAtomic() throws Exception {
    ...
    System.out.println("  Volatile counter: " + counter.getCount() +
        " (expected 10000)");
