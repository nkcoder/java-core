 ...
 *
 * <ul>
 *   <li>CAS operations on object references
 *   <li>Building lock-free data structures
 *   <li>ABA problem and solutions (stamped/markable references)
 *   <li>Immutable objects work best with atomic references
 * </ul>
 *
 * <p>Interview tip: Understand the ABA problem and when to use AtomicStampedReference vs AtomicMarkableReference.
 */
public class AtomicReferenceExample {
    ...
    static void basicOperations() {
        ...
        System.out.println(
                "  getAndSet(): old=" + old.name() + ", new=" + userRef.get().name());
    ...
    static void updateAndAccumulate() {
        ...
        Counter combined =
                ref.accumulateAndGet(new Counter(10), (current, given) -> new Counter(current.value() + given.value()));
