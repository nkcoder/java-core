 ...
 *
 * <ul>
 *   <li>Every write creates a new copy of the underlying array
 *   <li>Reads never block (no synchronization)
 *   <li>Iterators see a snapshot (never throw ConcurrentModificationException)
 *   <li>Best for: many reads, few writes, small to medium size
 * </ul>
 *
 * <p>Interview tip: Know when to use CopyOnWrite vs other concurrent collections, and understand the memory/performance
 * tradeoffs.
 */
public class CopyOnWriteListExample {
    ...
    static void iteratorBehavior() throws Exception {
        ...
        CopyOnWriteArrayList<String> names = new CopyOnWriteArrayList<>(List.of("Alice", "Bob", "Charlie"));
