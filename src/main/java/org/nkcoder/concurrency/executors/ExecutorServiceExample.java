 ...
 *
 * <ul>
 *   <li>Thread pools avoid the overhead of creating threads for each task
 *   <li>Different executor types for different use cases
 *   <li>Proper shutdown is critical to avoid resource leaks
 *   <li>Future allows retrieving results and handling exceptions
 * </ul>
 *
