 ...
 *
 * <p><strong>Java 25 Status:</strong> Core language feature, unchanged. Well-designed custom exceptions improve error
 * handling and debugging.
 *
 * <p>Key concepts:
 *
 * <ul>
 *   <li>When to create custom exceptions
 *   <li>Checked vs unchecked custom exceptions
 *   <li>Exception with rich context
 *   <li>Exception hierarchies
 * </ul>
 */
public class CustomExceptionExample {
    ...
    static class ApiException extends RuntimeException {
        ...
        public ApiException(
                int statusCode, String errorCode, String message, Throwable cause, Map<String, Object> context) {
            super(message, cause);
        ...
        public String toString() {
            return String.format("ApiException[%d %s] %s (context=%s)", statusCode, errorCode, getMessage(), context);
        }
    }
    ...
    static void richContextException() {
        ...
        try {
            throw new ApiException(
                    ...
                    "User does not exist",
                    null,
                    Map.of("userId", 12345L, "requestedBy", "admin"));
