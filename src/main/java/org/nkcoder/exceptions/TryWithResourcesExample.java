 ...
 *
 * <p><strong>Java 25 Status:</strong> Core language feature, stable since Java 7. Enhanced in Java 9 to allow
 * effectively final variables.
 *
 * <p>Key concepts:
 *
 * <ul>
 *   <li>AutoCloseable interface for automatic cleanup
 *   <li>Guaranteed close() even if exception thrown
 *   <li>Multiple resources closed in reverse order
 *   <li>Suppressed exceptions preserved
 * </ul>
 */
public class TryWithResourcesExample {
    ...
    static void suppressedExceptions() {
        ...
        try (FailingResource r1 = new FailingResource("R1", false, true);
