 ...
 *
 * <p><strong>Java 25 Status:</strong> Core language feature, unchanged. Generic methods
 * allow type parameters independent of the enclosing class.
 *
 * <p>Key concepts:
 * <ul>
 *   <li>Type parameter declaration before return type</li>
 *   <li>Static generic methods</li>
...
public class GenericMethodsExample {
  ...
  public static <T, C extends Collection<T>> C toCollection(
      Iterable<T> source, Supplier<C> collectionFactory) {
