 ...
 *
 * <p><strong>Java 25 Status:</strong> Core language feature, unchanged. Bounded types allow you to restrict what types
 * can be used as type arguments.
 *
 * <p>Key concepts:
 *
 * <ul>
 *   <li>Upper bounds: T extends Type
 *   <li>Multiple bounds: T extends A & B & C
 *   <li>Recursive bounds: T extends Comparable&lt;T&gt;
 *   <li>Bounded wildcards vs bounded type parameters
 * </ul>
 */
public class BoundedTypesExample {
    ...
    static void comparablePattern() {
        ...
        List<Dog> dogs = List.of(new Dog("Max", 5), new Dog("Buddy", 3), new Dog("Charlie", 7));
    ...
    static void realWorldExamples() {
        ...
        String result =
                new ConcreteBuilder().name("test").value(42).extra("additional").build();
