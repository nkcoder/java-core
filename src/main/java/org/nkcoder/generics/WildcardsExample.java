 ...
 *
 * <p><strong>Java 25 Status:</strong> Core language feature, unchanged. Wildcards enable more flexible APIs while
 * maintaining type safety.
 *
 * <p>Key concepts:
 *
 * <ul>
 *   <li>Unbounded wildcard: ? (unknown type)
 *   <li>Upper bounded: ? extends T (read-only, covariant)
 *   <li>Lower bounded: ? super T (write-only, contravariant)
 *   <li>PECS principle: Producer Extends, Consumer Super
 * </ul>
 */
