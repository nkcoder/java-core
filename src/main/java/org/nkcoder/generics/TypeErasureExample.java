 ...
 *
 * <p><strong>Java 25 Status:</strong> Core language behavior, unchanged. Understanding type erasure is essential for
 * working effectively with generics.
 *
 * <p>Key concepts:
 *
 * <ul>
 *   <li>Generics are a compile-time feature
 *   <li>Type parameters are erased at runtime
 *   <li>Bridge methods maintain polymorphism
 *   <li>Limitations and workarounds
 * </ul>
 */
public class TypeErasureExample {
    ...
    static void bridgeMethods() {
        ...
        for (Method m : StringProcessor.class.getDeclaredMethods()) {
            System.out.println(
                    "    " + m.getReturnType().getSimpleName() + " " + m.getName() + "(...) - bridge: " + m.isBridge());
        }
