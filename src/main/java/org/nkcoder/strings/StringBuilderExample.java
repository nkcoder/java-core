 ...
 *
 * <p><strong>Java 25 Status:</strong> StringBuilder is still the recommended way for building
 * strings dynamically, especially in loops. StringBuffer is legacy (rarely needed).
 *
 * <p>Key concepts:
 *
 * <ul>
