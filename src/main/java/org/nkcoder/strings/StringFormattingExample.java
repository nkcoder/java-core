 ...
 *
 * <p><strong>Java 25 Status:</strong> All formatting methods shown are stable.
 * String.format() and formatted() are the most commonly used approaches.
 *
 * <p>Key concepts:
 * <ul>
 *   <li>String.format() and printf()</li>
 *   <li>formatted() method (Java 15+)</li>
...
public class StringFormattingExample {
  ...
  static void dateTimeFormatting() {
    ...
    System.out.println("    ISO format: " + localNow.format(java.time.format.DateTimeFormatter.ISO_LOCAL_DATE_TIME));
