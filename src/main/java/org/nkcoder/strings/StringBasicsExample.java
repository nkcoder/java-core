 ...
 *
 * <p><strong>Java 25 Status:</strong> Fundamental concepts unchanged. Understanding string immutability and the string
 * pool is essential for writing efficient code.
 *
 * <p>Key concepts:
 *
 * <ul>
 *   <li>String immutability and its benefits
 *   <li>String pool (interning)
 *   <li>String comparison: == vs equals()
...
public class StringBasicsExample {
    ...
    static void equalsVsDoubleEquals() {
        ...
        System.out.println("    Objects.equals(nullStr, s1): " + Objects.equals(nullStr, s1));
