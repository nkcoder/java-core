 ...
 *
 * <ul>
 *   <li>Queue: FIFO (first-in-first-out)
 *   <li>Deque: double-ended queue (both ends accessible)
 *   <li>PriorityQueue: elements ordered by priority (heap)
 *   <li>ArrayDeque: faster than LinkedList for most use cases
 * </ul>
 */
