 ...
 *
 * <ul>
 *   <li>ArrayList: O(1) random access, O(n) insert/delete in middle
 *   <li>LinkedList: O(n) random access, O(1) insert/delete at ends
 *   <li>Java 9+: {@code List.of()} for immutable lists
 *   <li>Java 10+: {@code List.copyOf()} for immutable copy
 * </ul>
 */
