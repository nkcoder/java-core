 ...
 *
 * <ul>
 *   <li>HashSet: O(1) operations, no order guarantee
 *   <li>LinkedHashSet: O(1) operations, maintains insertion order
 *   <li>TreeSet: O(log n) operations, sorted order
 *   <li>Java 9+: {@code Set.of()} for immutable sets
 * </ul>
 */
