 ...
 *
 * <ul>
 *   <li>{@code List.of()}, {@code Set.of()}, {@code Map.of()}: truly immutable (Java 9+)
 *   <li>{@code Collections.unmodifiableXxx()}: unmodifiable view of mutable collection
 *   <li>{@code List.copyOf()}: immutable copy (Java 10+)
 *   <li>Defensive copies: protect internal state from external modification
 * </ul>
 */
