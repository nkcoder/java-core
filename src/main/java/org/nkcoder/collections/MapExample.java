 ...
 *
 * <ul>
 *   <li>HashMap: O(1) operations, no order guarantee
 *   <li>LinkedHashMap: O(1) operations, maintains insertion order
 *   <li>TreeMap: O(log n) operations, sorted by keys
 *   <li>Java 9+: {@code Map.of()}, {@code Map.entry()} for immutable maps
 * </ul>
 */
public class MapExample {
    ...
    static void factoryMethodsExample() {
        ...
        Map<String, Integer> larger =
                Map.ofEntries(Map.entry("one", 1), Map.entry("two", 2), Map.entry("three", 3), Map.entry("four", 4));
