 ...
 *
 * <ul>
 *   <li>Auto-generates: constructor, getters, equals, hashCode, toString</li>
 *   <li>Fields are final and private</li>
 *   <li>Cannot extend classes (implicitly extends Record)</li>
...
public class RecordExample {
  ...
  static void basicRecord() {
    ...
    System.out.println("p1.hashCode == p2.hashCode: " + (p1.hashCode() ==
        p2.hashCode()));
  ...
  static void recordMethods() {
    ...
    System.out.println("2. Accessors: name() = " + alice.name() + ", age() = " +
        alice.age());
