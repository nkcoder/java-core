 ...
 *
 * <ul>
 *   <li>Default methods (Java 8): Add behavior without breaking implementations
 *   <li>Static methods (Java 8): Utility methods tied to the interface
 *   <li>Private methods (Java 9): Helper methods for default method code reuse
 *   <li>Enables multiple inheritance of behavior (not state)
 * </ul>
 */
