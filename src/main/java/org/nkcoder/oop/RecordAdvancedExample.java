 ...
 *
 * <ul>
 *   <li>Records can implement interfaces
 *   <li>Generic records
 *   <li>Nested records
 *   <li>Records with collections (defensive copies)
 *   <li>Records in serialization
 * </ul>
 */
public class RecordAdvancedExample {
    ...
    static void recordsAndCollections() {
        ...
        List<Product> products =
                List.of(new Product("Apple", 1.50), new Product("Banana", 0.75), new Product("Cherry", 3.00));
