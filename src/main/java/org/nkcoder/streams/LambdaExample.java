 ...
 *   <li>Method references: {@code Class::method} shorthand</li>
 *   <li>Effectively final: lambdas can only capture final or effectively final
 variables</li>
 *   <li>Target typing: lambda type inferred from context</li>
 * </ul>
 */
public class LambdaExample {
  ...
  static void methodReferences() {
    ...
    System.out.println("Sorted by length: " +
        words.stream().sorted(byLength).toList());
  ...
  static void lambdaVsAnonymous() {
    ...
    Runnable lambda = () -> {
      ...
      // this.getClass() won't work because we are in static method scope, not class scope. We can use LambdaExample.class
      // System.out.println("  'this' refers to: " + this.getClass().getSimpleName());
    };
    lambda.run();
