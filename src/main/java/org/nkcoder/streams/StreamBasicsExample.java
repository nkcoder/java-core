 ...
 *
 * <ul>
 *   <li>Streams are lazy - intermediate ops don't execute until terminal op
 *   <li>Streams can only be consumed once
 *   <li>Intermediate: filter, map, flatmap, sorted, distinct, limit, skip
 *   <li>Terminal: forEach, collect, reduce, count, findFirst, anyMatch
 * </ul>
 */
public class StreamBasicsExample {
    ...
    static void intermediateOperations() {
        ...
        List<String> chaining = words.stream()
                .filter(s -> s.length() > 5)
