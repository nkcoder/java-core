 ...
 *
 * <ul>
 *   <li>Currying: Transform multi-arg function into chain of single-arg functions
 *   <li>Partial Application: Fix some arguments, return new function
 *   <li>Function Factories: Create specialized functions from general ones
 *   <li>Enables better code reuse and composition
 * </ul>
 */
public class CurryingExample {
    ...
    static void whatIsCurrying() {
        ...
        Function<Integer, Function<Integer, Function<Integer, Integer>>> curriedSum3 = a -> b -> c -> a + b + c;
        System.out.println(
                "curriedSum3(1)(2)(3) = " + curriedSum3.apply(1).apply(2).apply(3));
    ...
    static void realWorldExamples() {
        ...
        // 2. Validator Factory
        System.out.println("\n-- Validator Factory --");
        Function<Integer, Function<Integer, Function<String, String>>> rangeValidator = min -> max -> value -> {
            try {
        ...
        System.out.println("\n-- Discount Calculator --");
        Function<Double, UnaryOperator<Double>> discountBy = percent -> price -> price * (1 - percent / 100);
