 ...
 *
 * <p><strong>Java 25 Status:</strong> Finalized and production-ready. This is the recommended
 * way to do type checks in modern Java code.
 *
 * <p>Key concepts:
 * <ul>
 *   <li>Combines instanceof check with variable binding</li>
 *   <li>Eliminates redundant casting</li>
 *   <li>Pattern variable is in scope only where pattern matched</li>
 *   <li>Works with flow scoping (smart compiler)</li>
 * </ul>
 */
