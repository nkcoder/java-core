 ...
 *
 * <p><strong>Java 25 Status:</strong> Finalized and production-ready. Combining sealed types with pattern matching
 * enables the compiler to verify all cases are handled.
 *
 * <p>Key concepts:
 *
 * <ul>
 *   <li>Sealed types restrict which classes can implement/extend
 *   <li>Compiler knows all possible subtypes
 *   <li>Switch expressions must be exhaustive
 *   <li>No default needed when all cases covered
 * </ul>
 */
public class ExhaustiveSwitchExample {
    ...
    abstract static sealed class Shape permits Circle, Rectangle, Triangle {}
