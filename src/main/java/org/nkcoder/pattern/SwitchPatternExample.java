 ...
 *
 * <p><strong>Java 25 Status:</strong> Finalized in Java 21 and production-ready. Replaces
 * long if-else-instanceof chains with cleaner, more expressive switch statements.
 *
 * <p>Key concepts:
 * <ul>
 *   <li>Type patterns in case labels</li>
 *   <li>null handling in switch</li>
 *   <li>Pattern variable binding</li>
 *   <li>Combining with guarded patterns (when)</li>
 * </ul>
 */
public class SwitchPatternExample {
  ...
  static void realWorldExamples() {
    ...
    String response = switch (event) {
      ...
      case KeyEvent(char key, boolean shift) ->
    ...
    String message = switch (apiResponse) {
