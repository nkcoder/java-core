 ...
 *
 * <p><strong>Java 25 Status:</strong> Finalized and widely used. Prefer switch expressions
 * over switch statements for cleaner, more concise code.
 *
 * <p>Key concepts:
 * <ul>
 *   <li>Arrow syntax (->) for concise case handling</li>
 *   <li>Switch can return a value (expression, not just statement)</li>
 *   <li>No fall-through with arrow syntax</li>
 *   <li>yield keyword for multi-line cases</li>
 *   <li>Multiple labels per case</li>
 * </ul>
 */
public class SwitchExpressionExample {
  ...
  static void switchAsExpression() {
    ...
    System.out.println("  Status color: " + switch (status) {
      case "ACTIVE" -> "green";
      case "PENDING" -> "yellow";
      case "ERROR" -> "red";
      default -> "gray";
  ...
  static void realWorldExamples() {
    ...
    OrderState nextState = switch (state) {
    ...
    HttpResponse response = switch (httpStatus / 100) {
    ...
    String input = "YES";
    boolean confirmed = switch (input.toUpperCase()) {
